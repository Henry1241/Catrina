...
public class Cuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combMes.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mes", "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre" }));
    ...
    private void btnSeleccionaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionaActionPerformed
        ...
        try {
            ...
            if (filechooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                modeloResumen.addRow(new Object[]{formatMoneda.format(estado.suma(NORMAL)+ estado.saldoInicial(combMes.getSelectedIndex()))});

                //Se convierte un valor de tipo double a tipo String para imprimir en un label.
                String sub = String.valueOf(formatMoneda.format(estado.suma(NORMAL) + estado.saldoInicial(combMes.getSelectedIndex())));
